...
sources:
  - label: "Wertheimer. Laws of Organization in Perceptual Forms"
    year: "1923"
  - label: "Köhler. Gestalt Psychology"
    year: "1929"
---
...
- Either principle can dominate depending on relative magnitude; proximity is often the strongest grouping cue, but color or shape similarity can override it.
...
## Key Numbers
- **4-8px** — Related elements
- **16-24px** — Within a section
