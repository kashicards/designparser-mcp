...
sources:
  - label: "Jones and Mewhort. Case and letter identification. Psychological Review 111(3)"
    year: "2004"
---

## The Rule
- X-height: the distance from baseline to the top of lowercase letters like x, v, w, z.
- X-height varies widely: typically 45–75% of cap height depending on the typeface. No single optimal ratio applies universally.
...
## Why
- Over 90% of text is lowercase (Jones & Mewhort, 2004, corpus analysis). X-height determines the perceived size of type.
...
## In Practice
- In UI at sizes below 14px, use Inter or Verdana (high x-height) instead of Garamond (low). Legibility measurably improves for small text when x-height is higher.
